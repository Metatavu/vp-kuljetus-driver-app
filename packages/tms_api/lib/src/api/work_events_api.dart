...
class WorkEventsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [WorkEvent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WorkEvent>> createEmployeeWorkEvent({
    required String employeeId,
    required WorkEvent workEvent,
    ...
    final _path = r'/user-management/v1/employees/{employeeId}/workEvents'
        .replaceAll(
            '{' r'employeeId' '}',
    ...
    try {
      const _type = FullType(WorkEvent);
      _bodyData = _serializers.serialize(workEvent, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(WorkEvent),
            ) as WorkEvent;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future] containing a [Response] with a [WorkEvent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WorkEvent>> findEmployeeWorkEvent({
    required String employeeId,
    required String workEventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path =
        r'/user-management/v1/employees/{employeeId}/workEvents/{workEventId}'
            .replaceAll(
                '{' r'employeeId' '}',
                encodeQueryParameter(
                        _serializers, employeeId, const FullType(String))
            ...
            .replaceAll(
                '{' r'workEventId' '}',
                encodeQueryParameter(
                        _serializers, workEventId, const FullType(String))
                    .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<WorkEvent>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<WorkEvent>>> listEmployeeWorkEvents({
    ...
    BuiltList<WorkEvent>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(WorkEvent)]),
            ) as BuiltList<WorkEvent>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<WorkEvent>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [WorkEvent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WorkEvent>> updateEmployeeWorkEvent({
    required String employeeId,
    required String workEventId,
    required WorkEvent workEvent,
    CancelToken? cancelToken,
