...
class _$UserInfoImpl implements _UserInfo {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, sub, email, emailVerified, name,
      preferredUsername, givenName, locale, familyName);
...
abstract class _UserInfo implements UserInfo {
  const factory _UserInfo(
      ...
      final String? givenName,
      final String? locale,
      final String? familyName}) = _$UserInfoImpl;
