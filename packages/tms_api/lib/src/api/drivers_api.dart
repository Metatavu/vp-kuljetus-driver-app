...
class DriversApi {
  ...
  Future<Response<Driver>> findDriver({
    ...
    final _path = r'/user-management/v1/drivers/{driverId}'.replaceAll(
        '{' r'driverId' '}',
        encodeQueryParameter(_serializers, driverId, const FullType(String))
            .toString());
