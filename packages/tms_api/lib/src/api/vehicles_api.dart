...
class VehiclesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Vehicle] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Vehicle>> createVehicle({
    ...
    final _path = r'/vehicle-management/v1/vehicles';
    ...
    try {
      const _type = FullType(Vehicle);
      _bodyData = _serializers.serialize(vehicle, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Vehicle] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Vehicle>> findVehicle({
    ...
    final _path = r'/vehicle-management/v1/vehicles/{vehicleId}'.replaceAll(
        '{' r'vehicleId' '}',
        encodeQueryParameter(_serializers, vehicleId, const FullType(String))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Vehicle>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Vehicle>>> listVehicles({
    String? truckId,
    bool? archived,
    int? first,
    int? max,
    ...
    BuiltList<Vehicle>? _responseData;
    ...
    return Response<BuiltList<Vehicle>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
