...
class ClientAppsApi {
  ...
  const ClientAppsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ClientApp] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ClientApp>> createClientApp({
    required ClientApp clientApp,
    ...
    final _path = r'/user-management/v1/clientApps';
    ...
    try {
      const _type = FullType(ClientApp);
      _bodyData = _serializers.serialize(clientApp, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ClientApp),
            ) as ClientApp;
    } catch (error, stackTrace) {
      throw DioException(
