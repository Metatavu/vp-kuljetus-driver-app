...
class TasksApi {
  ...
  Future<Response<Task>> findTask({
    ...
    final _path = r'/delivery-info/v1/tasks/{taskId}'.replaceAll(
        '{' r'taskId' '}',
  ...
  /// Parameters:
  /// * [routeId] - Route id
  /// * [assignedToRoute] - Has been assigned to a route. Should not be used together with routeId.
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Task>>> listTasks({
    String? routeId,
    ...
    final _path = r'/delivery-info/v1/tasks';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (assignedToRoute != null)
        r'assignedToRoute': encodeQueryParameter(
            _serializers, assignedToRoute, const FullType(bool)),
      if (freightId != null)
        r'freightId': encodeQueryParameter(
            _serializers, freightId, const FullType(String)),
      if (customerSiteId != null)
        r'customerSiteId': encodeQueryParameter(
            _serializers, customerSiteId, const FullType(String)),
      if (type != null)
        r'type':
